...
- 文档：[PRD](docs/PRD.md) · [决策记录](docs/DECISIONS.md) · [代码现状](docs/STATUS.md)
- 设计规格：[牛群行为](docs/Herd_BEHAVIOR.md) · [草场](docs/GRASSLAND.md) · [日循环](docs/DAY_CYCLE.md) · [工程结构](docs/ARCHITECTURE.md)
